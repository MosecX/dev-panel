...
const StartupContainer = () => {
    ...
    css={tw`
        flex-1 rounded-xl border border-[rgba(255,255,255,0.08)]
    ...
    <div css={tw`px-1 py-2`}>
        <p
            css={tw`
                ...
                rounded-lg py-2 px-4 text-neutral-200 shadow-inner
            `}
        >
            {data.invocation}
        </p>
...
<TitledGreyBox
    title={'Docker Image'}
    css={tw`
        flex-1 lg:flex-none lg:w-1/3 mt-8 md:mt-0 md:ml-10
