...
const VariableBox = ({ variable }: Props) => {
    ...
    return (
        <TitledGreyBox
    title={
        <p className="text-sm uppercase text-neutral-200 font-semibold">
            {!variable.isEditable && (
                <span
                    className="
                        bg-[rgba(156,163,175,0.2)] border border-neutral-400/40 
                        text-neutral-300 text-xs py-1 px-2 rounded-full mr-2 mb-1 
                        backdrop-blur-md
                    "
                >
                    Read Only
    ...
    css={tw`
        ...
        bg-[rgba(255,255,255,0.05)] backdrop-blur-md shadow-lg p-4
    `}
>
    ...
    <p className="mt-1 text-xs text-neutral-400">{variable.description}</p>
</TitledGreyBox>
