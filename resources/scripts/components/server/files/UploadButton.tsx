        ...
        <>
                ...
                <Fade appear in={visible.value} timeout={75} key={'upload_modal_mask'} unmountOnExit>
                    ...
                    >
                        <div className="w-full flex items-center justify-center pointer-events-none">
                            <div
                                className="flex items-center space-x-4 w-full max-w-sm mx-10 p-6 rounded-xl 
                                           border border-[rgba(255,255,255,0.08)] backdrop-blur-xl 
                                           bg-[rgba(255,255,255,0.06)] shadow-2xl ring-4 ring-cyan-400/40"
                            >
                                <CloudUploadIcon className="w-10 h-10 flex-shrink-0 text-cyan-300" />
                                <p className="font-header flex-1 text-lg text-cyan-200 text-center">
            ...
            <Button
                className={`rounded-lg border border-cyan-400/40 bg-[rgba(255,255,255,0.08)] backdrop-blur-md 
                            text-cyan-300 hover:border-cyan-300 hover:text-white transition-all duration-300 ${className}`}
