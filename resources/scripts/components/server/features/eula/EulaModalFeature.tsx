    ...
    return (
        ...
        >
            ...
            <p css={tw`text-neutral-200`}>
                By pressing <span css={tw`text-neutral-100 font-medium`}>"I Accept"</span> below you are indicating your agreement to the&nbsp;
                <a
                    target="_blank"
                    rel="noreferrer noopener"
                    href="https://www.minecraft.net/eula"
                    css={tw`
                        text-blue-300 underline transition-colors duration-200 
                        hover:text-blue-400
                    `}
                >
                    Minecraft&reg; EULA
            ...
            <div css={tw`mt-8 sm:flex items-center justify-end`}>
                ...
                <Button
                    ...
                    css={tw`
                        mt-4 sm:mt-0 sm:ml-4 w-full sm:w-auto px-6 py-2 rounded-lg 
                        border border-green-400/40 
                        bg-[rgba(34,197,94,0.15)] backdrop-blur-md 
                        text-green-300 font-semibold shadow-md 
                        transition hover:scale-105 hover:text-green-200
                    `}
                >
                    I Accept
                </Button>
