                    ...
                    <motion.div
                        ...
                        {...getFloatingProps({
                            ...
                            className: classNames(
                                'text-sm px-3 py-2 rounded-lg pointer-events-none max-w-[24rem] shadow-lg',
                                'bg-[rgba(0,0,0,0.75)] backdrop-blur-md border border-[rgba(255,255,255,0.08)] text-gray-200',
                                props.className
                            ),
                            style: {
                                position: strategy,
                    ...
                    >
                        ...
                        {props.arrow && (
                            <div
                                ...
                                className={classNames(
                                    'absolute w-3 h-3',
                                    'bg-[rgba(0,0,0,0.75)] backdrop-blur-md border border-[rgba(255,255,255,0.08)]',
                                    side
                                )}
                            />
                        )}
