...
const BarFill = styled.div`
    ...
    box-shadow: 0 -2px 12px 2px rgba(34, 211, 238, 0.6);
    border-radius: 2px;
`;
...
const ProgressBar: React.FC = () => {
    ...
    return (
        <div css={tw`w-full fixed top-0 left-0`} style={{ height: '3px', zIndex: 9999 }}>
            <CSSTransition timeout={200} appear in={visible} unmountOnExit classNames={'fade'}>
