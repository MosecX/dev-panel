                        ...
                        <div className={'fixed inset-0 overflow-y-auto z-50'}>
                            ...
                            >
                                <HDialog.Panel
                                    ...
                                    className={
                                        styles.panel +
                                        ' backdrop-blur-md rounded-xl shadow-xl border border-[rgba(255,255,255,0.08)] text-gray-200'
                                    }
                                >
                                            ...
                                            <div className={'flex items-center'}>
                                                ...
                                                <div>
                                                    {title && (
                                                        <HDialog.Title
                                                            className={
                                                                styles.title + ' text-gray-100 font-semibold'
                                                            }
                                                        >
                                                            {title}
                                                        </HDialog.Title>
                                                    ...
                                                    {description && (
                                                        <HDialog.Description className="text-gray-300">
                                                            {description}
                                                        </HDialog.Description>
                                                    )}
                                                </div>
                                    ...
                                    {!hideCloseIcon && (
                                        <div className={'absolute right-0 top-0 m-4'}>
                                            <Button.Text
                                                ...
                                                onClick={onClose}
                                                className={
                                                    'group backdrop-blur-md border border-[rgba(255,255,255,0.08)] text-gray-400 hover:text-white transition-colors duration-200 ease-in-out rounded-md'
                                                }
                                            >
