...
export const DropdownButtonRow = styled.button<{ danger?: boolean }>`
    ${tw`p-2 flex items-center rounded w-full text-gray-200 transition-all duration-200 ease-in-out`};

    &:hover {
        ${(props) =>
            props.danger
                ? tw`bg-red-600 text-white`
                : tw`bg-blue-900/30 text-white`};
    }
`;
            ...
            <div>
                ...
                <Fade timeout={150} in={this.state.visible} unmountOnExit>
                    <div
                        ...
                        style={{ width: '12rem', isolation: 'isolate' }}
                        css={tw`
                            fixed 
