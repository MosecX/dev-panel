...
const EditorContainer = styled.div`
    ...
    > div {
        ${tw`rounded h-full shadow-xl border border-[rgba(255,255,255,0.08)] backdrop-blur-md bg-[rgba(0,0,0,0.6)]`};
    }
...
const Editor: React.FC<Props> = ({ style, initialContent, filename, mode, fetchContent, onContentSaved, onModeChanged }) => {
